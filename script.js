        ...
        function createRoom() {
            ...
            myId = `GT-${randomPin}`;
            hostId = myId; // BUG FIX: Set hostId for host so export works
        ...
        function joinRoom() {
            ...
            if (role.startsWith('12A')) {
                ...
                // Format name for class: "Lớp Trưởng (12A1)" or just name
            }
        ...
        document.addEventListener('click', (e) => {
            ...
            const btn = document.querySelector('button[onclick="toggleDisplayMenu()"]');
